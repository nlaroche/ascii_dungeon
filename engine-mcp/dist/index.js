    ...
    try {
        ...
        switch (name) {
            ...
            case 'get_component_schema':
                result = await componentTools.getComponentSchema(args?.name);
                break;
            case 'search_components':
                result = await componentTools.searchComponents(args?.query);
                break;
            ...
            case 'get_nodes_by_category':
                result = await nodeTools.getNodesByCategory(args?.category);
                break;
            case 'search_nodes':
                result = await nodeTools.searchNodes(args?.query);
                break;
            case 'get_node_type':
                result = await nodeTools.getNodeType(args?.id);
                break;
            case 'get_node_stats':
            ...
            case 'extract_interfaces':
                result = typeTools.extractInterfaces(args?.filePath);
                break;
            case 'extract_types':
                result = typeTools.extractTypes(args?.filePath);
                break;
            case 'extract_exports':
                result = typeTools.extractExports(args?.filePath);
                break;
            case 'get_type_usages':
                result = typeTools.getTypeUsages(args?.typeName, args?.basePath || depTools.DEFAULT_BASE_PATH);
                break;
            // Dependency tools
            case 'build_dependency_graph':
                if (args?.refresh || !cachedGraph) {
                    cachedGraph = await depTools.buildDependencyGraph(args?.basePath || undefined);
                }
            ...
            case 'get_file_dependencies':
                ...
                result = depTools.getFileDependencies(args?.filePath, cachedGraph);
                break;
            case 'get_file_dependents':
                if (!cachedGraph) {
                    cachedGraph = await depTools.buildDependencyGraph();
                }
                result = depTools.getFileDependents(args?.filePath, cachedGraph);
                break;
            ...
            case 'find_core_modules':
                ...
                result = depTools.findCoreModules(cachedGraph, args?.threshold || 5);
                break;
            ...
            case 'extract_naming_conventions':
                result = await patternTools.extractNamingConventions(args?.basePath || undefined);
                break;
            case 'extract_decorator_patterns':
                result = await patternTools.extractDecoratorPatterns(args?.basePath || undefined);
                break;
            case 'extract_file_organization':
                result = await patternTools.extractFileOrganization(args?.basePath || undefined);
                break;
            case 'extract_code_patterns':
                result = await patternTools.extractCodePatterns(args?.basePath || undefined);
                break;
            case 'get_pattern_summary':
                result = await patternTools.getPatternSummary(args?.basePath || undefined);
                break;
            // Consistency tools
            case 'check_component_consistency':
                result = await consistencyTools.checkComponentConsistency(args?.basePath || undefined);
                break;
            case 'check_naming_consistency':
                result = await consistencyTools.checkNamingConsistency(args?.basePath || undefined);
                break;
            case 'check_import_consistency':
                result = await consistencyTools.checkImportConsistency(args?.basePath || undefined);
                break;
            case 'check_decorator_consistency':
                result = await consistencyTools.checkDecoratorConsistency(args?.basePath || undefined);
                break;
            case 'run_all_checks':
                result = await consistencyTools.runAllChecks(args?.basePath || undefined);
                break;
            // Runtime & debugging tools
            case 'build_project':
            ...
            case 'type_check':
                ...
                break;
            case 'run_tests':
                result = await runtimeTools.runTests(args?.pattern);
                break;
            ...
            case 'get_recently_modified_files':
                ...
                break;
            case 'analyze_code':
                result = await runtimeTools.analyzeCode(args?.code);
                break;
            ...
            case 'find_error_patterns':
                ...
                break;
            case 'read_log_file':
                result = await runtimeTools.readLogFile(args?.logPath, args?.lines);
                break;
            // Semantic documentation tools
            case 'list_doc_topics':
                ...
                break;
            case 'get_system_doc':
                result = docsTools.getSystemDoc(args?.system);
                break;
            case 'search_docs':
                result = docsTools.searchDocs(args?.query);
                break;
            case 'get_quick_reference':
                result = docsTools.getQuickReference(args?.task);
                break;
